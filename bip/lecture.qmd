...
$\rightarrow$ Truth-telling becomes a **dominant strategy**
...
- Total = $250 < 300$ $\rightarrow$ bridge **not built**
...
::: {.fragment}
**Under full assumptions** (perfect mobility, full information, many jurisdictions, no spillovers, no economies of scale) $\rightarrow$ **Pareto-efficient** provision of local public goods.
:::
...
Town A accepts a polluting factory $\rightarrow$ Town B bears the pollution costs. Town A does not count these when deciding.

$\rightarrow$ Individually rational decisions are **collectively inefficient**
...
Rich jurisdictions $\rightarrow$ high tax base $\rightarrow$ good schools

Poor jurisdictions $\rightarrow$ low tax base $\rightarrow$ poor services
...
**The payoff:**
- Apple, Google, Facebook, LinkedIn $\rightarrow$ European HQs in Dublin
...
::: {.fragment}
**The legal response:**
European Commission (2016), State Aid Case SA.38373 $\rightarrow$ ruled Apple's Irish arrangements illegal state aid, ordered **€13 billion** in back taxes.
:::
...
$\rightarrow$ Countries are playing a **repeated game** and the equilibrium involves rates below what a global social planner would choose.
:::
...
Single-peaked preferences + majority voting $\rightarrow$ median voter's ideal point is the Condorcet winner.
...
$\rightarrow$ They vote to **protect property values**

$\rightarrow$ They systematically oppose zoning that allows apartments, social housing, or higher density

$\rightarrow$ Result: **exclusionary zoning**
...
$\rightarrow$ Existing homeowners use political power to write residual rights in their favour

$\rightarrow$ They capture **regulatory rent**
